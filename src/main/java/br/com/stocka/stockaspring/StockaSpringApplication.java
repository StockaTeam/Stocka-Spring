...
public class StockaSpringApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		products.add(createProduct("1 2 3 E TA PRONTO 300 G", "Alimentos", "5.90", "7.49", "10.5", 100, "0106JBS3DX", "Corredor A Prateleira 10", LocalDate.of(2023, 6, 30)));
		...
		products.add(createProduct("ABACAXI CALDA HELOMAR 400G", "Alimentos", "7.84", "9.99", "10.5", 100, "0101AWC309", "Corredor A Prateleira 10", LocalDate.of(2023, 6, 30)));
		products.add(
		...
		products.add(createProduct("ABOBORA  C/ COCO CELESTE 300G", "Alimentos", "4.50", "6.49", "10.5", 100, "0103QM17FD", "Corredor A Prateleira 10", LocalDate.of(2023, 6, 30)));
		...
		products.add(
				createProduct("ABS ALWAYS PINK NOTURNO C/ ABAS 8UN", "Higiene", "5.22", "7.29", "10.5", 100, "01004J0Q8M", "Corredor A Prateleira 10", LocalDate.of(2023, 6, 30)));
		...
		products.add(createProduct("ABSORVENTE  INTIMUS GEL 8UN ", "Higiene", "4.80", "6.99", "10.5", 100, "0109DA1JZJ", "Corredor A Prateleira 10", LocalDate.of(2023, 6, 30)));
		...
		products.add(
				createProduct("ABSORVENTE INTIMUS GEL NOTURNO 8UN", "Higiene", "6.30", "8.99", "10.5", 100, "0109DA1JZP", "Corredor A Prateleira 10", LocalDate.of(2023, 6, 30)));
		products.add(
				createProduct("ABSORVENTE INTIMUS GEL SUPER 8UN", "Higiene", "4.30", "6.49", "10.5", 100, "0109DA1JZR", "Corredor A Prateleira 10", LocalDate.of(2023, 6, 30)));
		...
		products.add(createProduct("ABSORVENTE INTIMUS GEL ULTRA FINO NOTURNO 8UN", "Higiene", "6.90", "9.99", "10.5", 100,
